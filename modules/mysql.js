...
let insert = async function(tabela, obj, retorna_id = false){
...
let _delete = async function (tabela, condicao){
    return new Promise((resolve, reject) => {
...
let update = async function (tabela, params, condicao){
...
let execSQL = async function(sql, params = {}){
